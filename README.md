...
**Project Links**
-  SQL Analysis & Documentation: _[Pulse-Tecnology-Analysis-Sales & Customer Analytics](P[ulse_Technology/README.md](https://github.com/noemile8240/Pulse_Technology
))
...
- Project Management Professional (PMP), previously certified  
- Lean Six Sigma Green Belt  
- Experience applying Agile principles, sprint planning, and iterative delivery approaches  
- Led cross-functional initiatives, process improvements, and operational performance projects across technical and business teams  
